...
\begin{enumerate}[\it (a)]
    \item
        ...
        \end{align*}
        for $n \geq 1$.  Then $G'' + (\lambda - \mu)G = 0$ and the homogeneous Dirichlet boundary conditions imply $\mu - \lambda > 0$ and
        \begin{align*}
            G(y) = B\sin(\sqrt{\mu - \lambda}y)
        \end{align*}
        The condition $G(1) = 0$ implies
        \begin{align*}
            0 = B\sin(\sqrt{\mu - \lambda}) \qquad \implies \qquad \lambda - \mu = -\pi^2 m^2 \qquad \implies \qquad \lambda = -\pi^2(n^2 + m^2)
        \end{align*}
